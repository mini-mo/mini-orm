...
import io.github.minimo.orm.dsl.MysqlDialectGenerator;
import io.github.minimo.orm.dsl.Sort;
import io.github.minimo.orm.dsl.criteria.Criteria;
import io.github.minimo.orm.executor.JdbcTemplateExecutor;
import io.github.minimo.orm.setter.BaseEnumSetter;
import io.github.minimo.orm.setter.DefaultEnumSetter;
...
public class DatabaseTemplateTest {
  ...
  public void test_query_api() {
    ...
    var list_2 = db.createQuery("select * from users where name = ?", "test")
        .map(User.class)
        .list();
    Assertions.assertFalse(list_2.isEmpty());
  }
